...
granade = Item("Granade", "attack", "Deals 2000 damage", 2000)
...
def create_enemy(player_name):
	player_hp = random.randrange(10000, 15000)
	print("     Hp awarded      : " + bcolors.OKGREEN + str(player_hp) + bcolors.ENDC)
	player_mp = random.randrange(200, 600)
	print("     Mp awarded      : " + bcolors.OKBLUE + str(player_mp) + bcolors.ENDC)
	player_atk = random.randrange(400, 600)
...
while running:
	...
	for player in players:
		...
		if choice == 0:
			...
			print(bcolors.OKGREEN + "\n" + player.get_name() + " attacked " + enemies[enemy].name + " for", dmg,
			...
			if spell.type == "white":
				...
				print(
					bcolors.OKBLUE + "\n" + player.get_name() + " used " + spell.name + " heals for " + str(magic_dmg),
					"HP" + bcolors.ENDC)
			elif spell.type == "black":
				enemy = player.choose_target(enemies)
				enemies[enemy].take_damage(magic_dmg)
				print(bcolors.OKBLUE + "\n" + player.get_name() + " used " + spell.name + " deals " + str(magic_dmg),
			...
			if item.type == "potion":
				...
				print(
					bcolors.WARNING + "\n" + item.name + " deals " + str(item.prop) + " points of damage to " + enemies[
	...
	for enemy in enemies:
		...
		if enemy_choice == 0:
			...
			print(bcolors.FAIL + "\n" + enemy.name + " attacked for", enemy_dmg,
			...
			if spell.type == "white":
				...
				print(bcolors.FAIL + "\n" + enemy.get_name() + " used " + spell.name + " heals for " + str(magic_dmg),
				      "HP" + bcolors.ENDC)
			elif spell.type == "black":

				players[target].take_damage(magic_dmg)
				print(bcolors.OKBLUE + "\n" + enemy.get_name() + " used " + spell.name + " deals " + str(magic_dmg),
				      "points of damage to " + players[target].name + bcolors.ENDC)
